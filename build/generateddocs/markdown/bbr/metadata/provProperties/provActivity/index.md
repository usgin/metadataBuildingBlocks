...
- type: object
  properties:
    '@type':
      ...
      contains:
        const: prov:Activity
      description: Must include prov:Activity. Unlike cdifProv, does not require schema:Action
        dual typing.
    schema:name:
      type: string
    ...
    prov:wasInformedBy:
      description: Other activities that communicated information to this one (PROV-O
        activity-to-activity chain -- maps to schema:object in cdifProv)
      type: array
      items:
        anyOf:
        - type: object
