...
`cdif.bbr.metadata.profiles.cdifProfiles.CDIFxasProfile` *v0.1*
      ...
      "prov:used": [
        {
          "schema:instrument": {
            ...
            "schema:name": "APS 13-BM-D XAS beamline instrument",
            "schema:category": [
              {
                "@type": [
                  "schema:DefinedTerm"
...
```jsonld
{
  "@context": [
    ...
    "https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifProfiles/CDIFxasProfile/context.jsonld",
    {
      "@vocab": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
      "schema": "http://schema.org/",
      "dcterms": "http://purl.org/dc/terms/",
...
xas:487y54 a schema1:Dataset,
    ...
    prov:wasGeneratedBy [ a schema1:Action,
            ...
            prov:used [ schema1:instrument [ a schema1:Product,
                            ...
                            schema1:name "APS 13-BM-D XAS beamline instrument" ] ] ] .
...
xas:487y54123 a schema1:Dataset,
    ...
    prov:wasGeneratedBy [ a schema1:Action,
            ...
            prov:used [ schema1:instrument [ a schema1:Product,
                            ...
                            schema1:category "X-ray Absorption Spectroscopy" ;
                            schema1:hasPart [ a schema1:Product,
                                        schema1:Thing ;
                                    schema1:additionalProperty [ a schema1:PropertyValue ;
                                            schema1:alternateName "incident flux measurement method" ;
                                ...
                                [ a schema1:Product,
                                    ...
                                    schema1:additionalType "nxs:BaseClass/NXmonochromator" ;
                                    schema1:name "Si 111" ] ;
                            schema1:name "XAS analytical instrument system" ] ] ] .
...
description: CDIF XAS profile for X-ray Absorption Spectroscopy datasets. Composes
  cdifCore with discovery properties and XAS-specific constraints.
allOf:
...
- type: object
  properties:
    '@context':
      type: object
      description: Additional JSON-LD namespace prefixes for discovery and XAS properties.
      properties:
        geosparql:
...
* YAML version: [schema.yaml](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifProfiles/CDIFxasProfile/schema.json)
* JSON version: [schema.json](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifProfiles/CDIFxasProfile/schema.yaml)
...
[context.jsonld](https://cross-domain-interoperability-framework.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/cdifProfiles/CDIFxasProfile/context.jsonld)
...
* Path: `_sources/profiles/cdifProfiles/CDIFxasProfile`
