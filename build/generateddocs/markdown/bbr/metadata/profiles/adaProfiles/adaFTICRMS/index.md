...
`cdif.bbr.metadata.profiles.adaProfiles.adaFTICRMS` *v0.1*
...
Example Fourier Transform Ion Cyclotron Resonance Mass Spectrometry (FTICR-MS) product metadata with all properties populated.
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaFTICRMS/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaFTICRMS-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Fourier Transform Ion Cyclotron Resonance Mass Spectrometry (FTICRMS) Cube",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example Fourier Transform Ion Cyclotron Resonance Mass Spectrometry (FTICR-MS) product metadata demonstrating all properties defined by the adaFTICRMS profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adafticrms-example-001.zip" ;
            schema1:description "Archive containing FTICR-MS data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaFTICRMS-file-001,
                ex:adaFTICRMS-file-002 ;
            schema1:name "adaFTICRMS-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adafticrms-example-001" ;
            schema1:value "10.99999/adafticrms-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "FTICR-MS" ;
            schema1:termCode "FTICR-MS" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/FTICR-MS" ;
            schema1:name "Fourier Transform Ion Cyclotron Resonance Mass Spectrometry (FTICR-MS)" ] ;
    schema1:name "FTICR-MS Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaFTICRMS-metadata-001 ;
    schema1:url "https://astromat.org/products/adafticrms-example-001" ;
    schema1:variableMeasured ex:adaFTICRMS-var-001,
        ex:adaFTICRMS-var-002 ;
    schema1:version "1.0" ;
...
ex:adaFTICRMS-file-001 a schema1:ImageObject,
    ...
    schema1:name "ALH84001_FTICR-MS_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaFTICRMS-file-002 a schema1:DigitalDocument,
    ...
    schema1:name "ALH84001_FTICR-MS_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaFTICRMS-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "FTICR-MS primary measurement" ;
    schema1:description "Primary measured quantity from Fourier Transform Ion Cyclotron Resonance Mass Spectrometry (FTICR-MS) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/fticr-ms_primary" ;
    schema1:unitText "counts" .

ex:adaFTICRMS-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
...
* YAML version: [schema.yaml](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaFTICRMS/schema.json)
* JSON version: [schema.json](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaFTICRMS/schema.yaml)
...
[context.jsonld](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaFTICRMS/context.jsonld)
...
* Path: `_sources/profiles/adaProfiles/adaFTICRMS`
