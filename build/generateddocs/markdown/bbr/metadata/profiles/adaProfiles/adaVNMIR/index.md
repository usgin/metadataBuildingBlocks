...
`cdif.bbr.metadata.profiles.adaProfiles.adaVNMIR` *v0.1*
...
Example Visible, Near-Infrared, and Mid-Infrared Spectroscopy (VNMIR) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaVNMIR-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "VNMIR Analysis of Meteorite ALH 84001 Fragment",
  "schema:description": "Example Visible, Near-Infrared, and Mid-Infrared Spectroscopy (VNMIR) product metadata demonstrating all properties defined by the adaVNMIR profile. Contains mock data for testing and validation.",
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adavnmir-example-001",
    "schema:url": "https://doi.org/10.99999/adavnmir-example-001"
  },
  "schema:url": "https://astromat.org/products/adavnmir-example-001",
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Visible, Near-Infrared, and Mid-Infrared Spectroscopy (VNMIR)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/VNMIR"
  },
  "prov:wasGeneratedBy": [
    {
      "@type": [
      ...
      "schema:identifier": "session-vnmir-20260110-001",
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "VNMIR primary measurement"
      ],
      "schema:description": "Primary measured quantity from Visible, Near-Infrared, and Mid-Infrared Spectroscopy (VNMIR) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/vnmir_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaVNMIR-ALH84001-archive.zip",
      "schema:description": "Archive containing VNMIR data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adavnmir-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaVNMIR"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaVNMIR/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaVNMIR-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Visible, near-infrared, and mid-infrared Spectroscopy (VNMIR) Point",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example Visible, Near-Infrared, and Mid-Infrared Spectroscopy (VNMIR) product metadata demonstrating all properties defined by the adaVNMIR profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adavnmir-example-001.zip" ;
            schema1:description "Archive containing VNMIR data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaVNMIR-file-001,
                ex:adaVNMIR-file-002 ;
            schema1:name "adaVNMIR-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adavnmir-example-001" ;
            schema1:value "10.99999/adavnmir-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "VNMIR" ;
            schema1:termCode "VNMIR" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/VNMIR" ;
            schema1:name "Visible, Near-Infrared, and Mid-Infrared Spectroscopy (VNMIR)" ] ;
    schema1:name "VNMIR Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaVNMIR-metadata-001 ;
    schema1:url "https://astromat.org/products/adavnmir-example-001" ;
    schema1:variableMeasured ex:adaVNMIR-var-001,
        ex:adaVNMIR-var-002 ;
    schema1:version "1.0" ;
...
ex:adaVNMIR-file-002 a schema1:DigitalDocument,
    ...
    schema1:name "ALH84001_VNMIR_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
            schema1:value 524288 ] .

ex:adaVNMIR-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaVNMIR> ;
    schema1:about ex:adaVNMIR-example-001 ;
...
ex:adaVNMIR-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "VNMIR primary measurement" ;
    schema1:description "Primary measured quantity from Visible, Near-Infrared, and Mid-Infrared Spectroscopy (VNMIR) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/vnmir_primary" ;
    schema1:unitText "counts" .

ex:adaVNMIR-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
...
* YAML version: [schema.yaml](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaVNMIR/schema.json)
* JSON version: [schema.json](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaVNMIR/schema.yaml)
...
[context.jsonld](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaVNMIR/context.jsonld)
...
* Path: `_sources/profiles/adaProfiles/adaVNMIR`
