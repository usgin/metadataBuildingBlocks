...
### SLS Product Example
Example Structured Light Scanning (SLS) product metadata with all properties populated.
...
```json
{
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adasls-example-001",
    "schema:url": "https://doi.org/10.99999/adasls-example-001"
  },
  "schema:url": "https://astromat.org/products/adasls-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "Structured Light Scanning",
      "schema:termCode": "SLS",
      "schema:inDefinedTermSet": "https://ada.astromat.org/vocabulary/techniques",
      "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/SLS"
    },
    "meteorite",
    "astromaterials"
  ],
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Structured Light Scanning (SLS)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/SLS"
  },
  "prov:wasGeneratedBy": [
    {
      ...
      "schema:identifier": "session-sls-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example SLS Instrument",
          "schema:identifier": "ex:instrument-sls-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "SLS primary measurement"
      ],
      "schema:description": "Primary measured quantity from Structured Light Scanning (SLS) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/sls_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaSLS-ALH84001-archive.zip",
      "schema:description": "Archive containing SLS data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adasls-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaSLS"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaSLS/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaSLS-example-001 a schema1:Dataset,
    ...
    schema1:description "Example Structured Light Scanning (SLS) product metadata demonstrating all properties defined by the adaSLS profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adasls-example-001.zip" ;
            schema1:description "Archive containing SLS data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaSLS-file-001,
                ex:adaSLS-file-002 ;
            schema1:name "adaSLS-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adasls-example-001" ;
            schema1:value "10.99999/adasls-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/SLS" ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "Structured Light Scanning" ;
            schema1:termCode "SLS" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/SLS" ;
            schema1:name "Structured Light Scanning (SLS)" ] ;
    schema1:name "SLS Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaSLS-metadata-001 ;
    schema1:url "https://astromat.org/products/adasls-example-001" ;
    schema1:variableMeasured ex:adaSLS-var-001,
        ex:adaSLS-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-sls-20260110-001" ;
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:SLSInstrument" ;
...
ex:adaSLS-file-001 a schema1:ImageObject,
    ...
    schema1:name "ALH84001_SLS_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaSLS-file-002 a schema1:DigitalDocument,
    ...
    schema1:name "ALH84001_SLS_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
            schema1:value 524288 ] .

ex:adaSLS-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaSLS> ;
    schema1:about ex:adaSLS-example-001 ;
...
ex:adaSLS-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "SLS primary measurement" ;
    schema1:description "Primary measured quantity from Structured Light Scanning (SLS) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/sls_primary" ;
    schema1:unitText "counts" .

ex:adaSLS-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
