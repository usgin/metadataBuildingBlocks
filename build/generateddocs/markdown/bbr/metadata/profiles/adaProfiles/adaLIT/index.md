...
### LIT Product Example
Example Lock-In Thermography (LIT) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaLIT-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "LIT Analysis of Meteorite ALH 84001 Fragment",
  "schema:description": "Example Lock-In Thermography (LIT) product metadata demonstrating all properties defined by the adaLIT profile. Contains mock data for testing and validation.",
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adalit-example-001",
    "schema:url": "https://doi.org/10.99999/adalit-example-001"
  },
  "schema:url": "https://astromat.org/products/adalit-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "Lock-In Thermography",
      "schema:termCode": "LIT",
      "schema:inDefinedTermSet": "https://ada.astromat.org/vocabulary/techniques",
      "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/LIT"
    },
    "meteorite",
    "astromaterials"
  ],
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Lock-In Thermography (LIT)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/LIT"
  },
  "prov:wasGeneratedBy": [
    {
      ...
      "schema:identifier": "session-lit-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example LIT Instrument",
          "schema:identifier": "ex:instrument-lit-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "LIT primary measurement"
      ],
      "schema:description": "Primary measured quantity from Lock-In Thermography (LIT) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/lit_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaLIT-ALH84001-archive.zip",
      "schema:description": "Archive containing LIT data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adalit-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaLIT"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaLIT/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaLIT-example-001 a schema1:Dataset,
        schema1:Product ;
    ...
    schema1:description "Example Lock-In Thermography (LIT) product metadata demonstrating all properties defined by the adaLIT profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adalit-example-001.zip" ;
            schema1:description "Archive containing LIT data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaLIT-file-001,
                ex:adaLIT-file-002 ;
            schema1:name "adaLIT-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adalit-example-001" ;
            schema1:value "10.99999/adalit-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/LIT" ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "Lock-In Thermography" ;
            schema1:termCode "LIT" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/LIT" ;
            schema1:name "Lock-In Thermography (LIT)" ] ;
    schema1:name "LIT Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaLIT-metadata-001 ;
    schema1:url "https://astromat.org/products/adalit-example-001" ;
    schema1:variableMeasured ex:adaLIT-var-001,
        ex:adaLIT-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-lit-20260110-001" ;
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:LITInstrument" ;
                    schema1:identifier "ex:instrument-lit-001" ;
...
ex:adaLIT-file-001 a schema1:ImageObject,
    ...
    schema1:name "ALH84001_LIT_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaLIT-file-002 a schema1:DigitalDocument,
    ...
    schema1:name "ALH84001_LIT_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
            schema1:value 524288 ] .

ex:adaLIT-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaLIT> ;
    schema1:about ex:adaLIT-example-001 ;
...
ex:adaLIT-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "LIT primary measurement" ;
    schema1:description "Primary measured quantity from Lock-In Thermography (LIT) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/lit_primary" ;
    schema1:unitText "counts" .

ex:adaLIT-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
