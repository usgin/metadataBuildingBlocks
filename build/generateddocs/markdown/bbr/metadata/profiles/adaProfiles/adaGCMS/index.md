...
Example Gas Chromatography Mass Spectrometry (GC-MS) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaGCMS-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "GC-MS Analysis of Meteorite ALH 84001 Fragment",
  "schema:description": "Example Gas Chromatography Mass Spectrometry (GC-MS) product metadata demonstrating all properties defined by the adaGCMS profile. Contains mock data for testing and validation.",
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adagcms-example-001",
    "schema:url": "https://doi.org/10.99999/adagcms-example-001"
  },
  "schema:url": "https://astromat.org/products/adagcms-example-001",
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Gas Chromatography Mass Spectrometry (GC-MS)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/GC-MS"
  },
  "prov:wasGeneratedBy": [
    {
      "@type": [
      ...
      "schema:identifier": "session-gc-ms-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example GC-MS Instrument",
          "schema:identifier": "ex:instrument-gc-ms-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "GC-MS primary measurement"
      ],
      "schema:description": "Primary measured quantity from Gas Chromatography Mass Spectrometry (GC-MS) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/gc-ms_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaGCMS-ALH84001-archive.zip",
      "schema:description": "Archive containing GC-MS data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adagcms-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaGCMS"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaGCMS/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaGCMS-example-001 a schema1:Dataset,
        schema1:Product ;
    ...
    schema1:description "Example Gas Chromatography Mass Spectrometry (GC-MS) product metadata demonstrating all properties defined by the adaGCMS profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adagcms-example-001.zip" ;
            schema1:description "Archive containing GC-MS data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaGCMS-file-001,
                ex:adaGCMS-file-002 ;
            schema1:name "adaGCMS-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adagcms-example-001" ;
            schema1:value "10.99999/adagcms-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "GC-MS" ;
            schema1:termCode "GC-MS" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/GC-MS" ;
            schema1:name "Gas Chromatography Mass Spectrometry (GC-MS)" ] ;
    schema1:name "GC-MS Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaGCMS-metadata-001 ;
    schema1:url "https://astromat.org/products/adagcms-example-001" ;
    schema1:variableMeasured ex:adaGCMS-var-001,
        ex:adaGCMS-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-gc-ms-20260110-001" ;
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:GC-MSInstrument" ;
...
ex:adaGCMS-file-001 a schema1:ImageObject,
    ...
    schema1:name "ALH84001_GC-MS_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaGCMS-metadata-001 a schema1:Dataset ;
    ...
    schema1:about ex:adaGCMS-example-001 ;
...
ex:adaGCMS-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "GC-MS primary measurement" ;
    schema1:description "Primary measured quantity from Gas Chromatography Mass Spectrometry (GC-MS) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/gc-ms_primary" ;
    schema1:unitText "counts" .

ex:adaGCMS-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
