...
Example Nanoscale Secondary Ion Mass Spectrometry (NanoSIMS) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaNanoSIMS-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "NanoSIMS Analysis of Meteorite ALH 84001 Fragment",
  ...
  "schema:url": "https://astromat.org/products/adananosims-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "NanoSIMS",
      "schema:termCode": "NanoSIMS",
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Nanoscale Secondary Ion Mass Spectrometry (NanoSIMS)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/NanoSIMS"
  },
  "prov:wasGeneratedBy": [
    {
      "@type": [
      ...
      "schema:identifier": "session-nanosims-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example NanoSIMS Instrument",
          "schema:identifier": "ex:instrument-nanosims-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaNanoSIMS-ALH84001-archive.zip",
      "schema:description": "Archive containing NanoSIMS data files and supplementary materials",
  ...
  "schema:subjectOf": {
    ...
    "@id": "ex:adaNanoSIMS-metadata-001",
    "schema:about": {
      "@id": "ex:adaNanoSIMS-example-001"
    },
    "schema:dateModified": "2026-01-15",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaNanoSIMS/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaNanoSIMS-example-001 a schema1:Dataset,
    ...
    schema1:distribution [ a schema1:DataDownload ;
            ...
            schema1:hasPart ex:adaNanoSIMS-file-001,
                ex:adaNanoSIMS-file-002 ;
            schema1:name "adaNanoSIMS-ALH84001-archive.zip" ;
    ...
    schema1:keywords [ a schema1:DefinedTerm ;
            ...
            schema1:name "NanoSIMS" ;
            schema1:termCode "NanoSIMS" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/NanoSIMS" ;
            schema1:name "Nanoscale Secondary Ion Mass Spectrometry (NanoSIMS)" ] ;
    schema1:name "NanoSIMS Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaNanoSIMS-metadata-001 ;
    schema1:url "https://astromat.org/products/adananosims-example-001" ;
    schema1:variableMeasured ex:adaNanoSIMS-var-001,
        ex:adaNanoSIMS-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-nanosims-20260110-001" ;
