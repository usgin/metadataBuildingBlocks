...
`cdif.bbr.metadata.profiles.adaProfiles.adaICPOES` *v0.1*
...
Example Inductively Coupled Plasma Optical Emission Spectrometry (ICP-OES) product metadata with all properties populated.
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaICPOES/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaICPOES-example-001 a schema1:Dataset,
    ...
    schema1:description "Example Inductively Coupled Plasma Optical Emission Spectrometry (ICP-OES) product metadata demonstrating all properties defined by the adaICPOES profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adaicpoes-example-001.zip" ;
            schema1:description "Archive containing ICP-OES data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaICPOES-file-001,
                ex:adaICPOES-file-002 ;
            schema1:name "adaICPOES-ALH84001-archive.zip" ;
    ...
    schema1:keywords [ a schema1:DefinedTerm ;
            ...
            schema1:name "ICP-OES" ;
            schema1:termCode "ICP-OES" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/ICP-OES" ;
            schema1:name "Inductively Coupled Plasma Optical Emission Spectrometry (ICP-OES)" ] ;
    schema1:name "ICP-OES Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaICPOES-metadata-001 ;
    schema1:url "https://astromat.org/products/adaicpoes-example-001" ;
    schema1:variableMeasured ex:adaICPOES-var-001,
        ex:adaICPOES-var-002 ;
    schema1:version "1.0" ;
...
ex:adaICPOES-var-001 a cdi:InstanceVariable,
...
ex:adaICPOES-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
...
* YAML version: [schema.yaml](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaICPOES/schema.json)
* JSON version: [schema.json](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaICPOES/schema.yaml)
...
[context.jsonld](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaICPOES/context.jsonld)
...
* Path: `_sources/profiles/adaProfiles/adaICPOES`
