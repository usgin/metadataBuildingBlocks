...
`cdif.bbr.metadata.profiles.adaProfiles.adaLAF` *v0.1*
...
### LAF Product Example
Example Laser-Assisted Fluorination (LAF) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaLAF-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "LAF Analysis of Meteorite ALH 84001 Fragment",
  "schema:description": "Example Laser-Assisted Fluorination (LAF) product metadata demonstrating all properties defined by the adaLAF profile. Contains mock data for testing and validation.",
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adalaf-example-001",
    "schema:url": "https://doi.org/10.99999/adalaf-example-001"
  },
  "schema:url": "https://astromat.org/products/adalaf-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "Laser Assisted Fluorination",
      "schema:termCode": "LAF",
      "schema:inDefinedTermSet": "https://ada.astromat.org/vocabulary/techniques",
      "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/LAF"
    },
    "meteorite",
    "astromaterials"
  ],
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Laser-Assisted Fluorination (LAF)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/LAF"
  },
  "prov:wasGeneratedBy": [
    {
      ...
      "schema:identifier": "session-laf-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example LAF Instrument",
          "schema:identifier": "ex:instrument-laf-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "LAF primary measurement"
      ],
      "schema:description": "Primary measured quantity from Laser-Assisted Fluorination (LAF) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/laf_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaLAF-ALH84001-archive.zip",
      "schema:description": "Archive containing LAF data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adalaf-example-001.zip",
      ...
      "schema:hasPart": [
        {
          "@id": "ex:adaLAF-file-001",
          "@type": [
            "ada:image",
            "schema:ImageObject"
          ],
          "schema:name": "ALH84001_LAF_001.tif",
          "schema:description": "LAF data file for ALH 84001 thin section",
          "schema:additionalType": [
            "ada:LAFProcessed"
          ],
          "schema:encodingFormat": [
        ...
        {
          "@id": "ex:adaLAF-file-002",
          "@type": [
            "ada:document",
            "schema:DigitalDocument"
          ],
          "schema:name": "ALH84001_LAF_methods.pdf",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaLAF"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaLAF/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaLAF-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Laser Assisted Fluorination (LAF) Processed",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example Laser-Assisted Fluorination (LAF) product metadata demonstrating all properties defined by the adaLAF profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adalaf-example-001.zip" ;
            schema1:description "Archive containing LAF data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaLAF-file-001,
                ex:adaLAF-file-002 ;
            schema1:name "adaLAF-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adalaf-example-001" ;
            schema1:value "10.99999/adalaf-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/LAF" ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "Laser Assisted Fluorination" ;
            schema1:termCode "LAF" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/LAF" ;
            schema1:name "Laser-Assisted Fluorination (LAF)" ] ;
    schema1:name "LAF Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaLAF-metadata-001 ;
    schema1:url "https://astromat.org/products/adalaf-example-001" ;
    schema1:variableMeasured ex:adaLAF-var-001,
        ex:adaLAF-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-laf-20260110-001" ;
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:LAFInstrument" ;
                    schema1:identifier "ex:instrument-laf-001" ;
                    schema1:name "Example LAF Instrument" ] ] .

ex:adaLAF-file-001 a schema1:ImageObject,
        ada:image ;
    schema1:additionalType "ada:LAFProcessed" ;
    schema1:description "LAF data file for ALH 84001 thin section" ;
    schema1:encodingFormat "image/tiff" ;
    schema1:name "ALH84001_LAF_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaLAF-file-002 a schema1:DigitalDocument,
        ada:document ;
    schema1:additionalType "ada:methodDescription" ;
    schema1:description "Method description document for this analysis" ;
    schema1:encodingFormat "application/pdf" ;
    schema1:name "ALH84001_LAF_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
            schema1:value 524288 ] .

ex:adaLAF-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaLAF> ;
    schema1:about ex:adaLAF-example-001 ;
...
ex:adaLAF-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "LAF primary measurement" ;
    schema1:description "Primary measured quantity from Laser-Assisted Fluorination (LAF) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/laf_primary" ;
    schema1:unitText "counts" .

ex:adaLAF-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
...
* YAML version: [schema.yaml](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaLAF/schema.json)
* JSON version: [schema.json](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaLAF/schema.yaml)
...
[context.jsonld](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaLAF/context.jsonld)
...
* Path: `_sources/profiles/adaProfiles/adaLAF`
