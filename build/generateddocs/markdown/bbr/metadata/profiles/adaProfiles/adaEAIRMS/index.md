...
`cdif.bbr.metadata.profiles.adaProfiles.adaEAIRMS` *v0.1*
...
Example Elemental Analysis - Isotope Ratio Mass Spectrometry (EA-IRMS) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaEAIRMS-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "EA-IRMS Analysis of Meteorite ALH 84001 Fragment",
  "schema:description": "Example Elemental Analysis - Isotope Ratio Mass Spectrometry (EA-IRMS) product metadata demonstrating all properties defined by the adaEAIRMS profile. Contains mock data for testing and validation.",
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adaeairms-example-001",
    "schema:url": "https://doi.org/10.99999/adaeairms-example-001"
  },
  "schema:url": "https://astromat.org/products/adaeairms-example-001",
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Elemental Analysis - Isotope Ratio Mass Spectrometry (EA-IRMS)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/EA-IRMS"
  },
  "prov:wasGeneratedBy": [
    {
      "@type": [
      ...
      "schema:identifier": "session-ea-irms-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example EA-IRMS Instrument",
          "schema:identifier": "ex:instrument-ea-irms-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "EA-IRMS primary measurement"
      ],
      "schema:description": "Primary measured quantity from Elemental Analysis - Isotope Ratio Mass Spectrometry (EA-IRMS) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/ea-irms_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaEAIRMS-ALH84001-archive.zip",
      "schema:description": "Archive containing EA-IRMS data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adaeairms-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaEAIRMS"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaEAIRMS/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaEAIRMS-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Elemental Analysis-Isotope Ratio Mass Spectrometry (EA-IRMS)",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example Elemental Analysis - Isotope Ratio Mass Spectrometry (EA-IRMS) product metadata demonstrating all properties defined by the adaEAIRMS profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adaeairms-example-001.zip" ;
            schema1:description "Archive containing EA-IRMS data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaEAIRMS-file-001,
                ex:adaEAIRMS-file-002 ;
            schema1:name "adaEAIRMS-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adaeairms-example-001" ;
            schema1:value "10.99999/adaeairms-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "EA-IRMS" ;
            schema1:termCode "EA-IRMS" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/EA-IRMS" ;
            schema1:name "Elemental Analysis - Isotope Ratio Mass Spectrometry (EA-IRMS)" ] ;
    schema1:name "EA-IRMS Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaEAIRMS-metadata-001 ;
    schema1:url "https://astromat.org/products/adaeairms-example-001" ;
    schema1:variableMeasured ex:adaEAIRMS-var-001,
        ex:adaEAIRMS-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:EA-IRMSInstrument" ;
...
ex:adaEAIRMS-file-001 a schema1:ImageObject,
    ...
    schema1:name "ALH84001_EA-IRMS_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaEAIRMS-file-002 a schema1:DigitalDocument,
    ...
    schema1:name "ALH84001_EA-IRMS_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
            schema1:value 524288 ] .

ex:adaEAIRMS-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaEAIRMS> ;
...
ex:adaEAIRMS-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "EA-IRMS primary measurement" ;
    schema1:description "Primary measured quantity from Elemental Analysis - Isotope Ratio Mass Spectrometry (EA-IRMS) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/ea-irms_primary" ;
    schema1:unitText "counts" .

ex:adaEAIRMS-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
...
* YAML version: [schema.yaml](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaEAIRMS/schema.json)
* JSON version: [schema.json](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaEAIRMS/schema.yaml)
...
[context.jsonld](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaEAIRMS/context.jsonld)
...
* Path: `_sources/profiles/adaProfiles/adaEAIRMS`
