...
`cdif.bbr.metadata.profiles.adaProfiles.adaVLM` *v0.1*
...
### VLM Product Example
Example Visible Light Microscopy (VLM) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaVLM-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "VLM Analysis of Meteorite ALH 84001 Fragment",
  "schema:description": "Example Visible Light Microscopy (VLM) product metadata demonstrating all properties defined by the adaVLM profile. Contains mock data for testing and validation.",
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adavlm-example-001",
    "schema:url": "https://doi.org/10.99999/adavlm-example-001"
  },
  "schema:url": "https://astromat.org/products/adavlm-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "Visible Light Microscopy",
      "schema:termCode": "VLM",
      "schema:inDefinedTermSet": "https://ada.astromat.org/vocabulary/techniques",
      "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/VLM"
    },
    "meteorite",
    "astromaterials"
  ],
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Visible Light Microscopy (VLM)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/VLM"
  },
  "prov:wasGeneratedBy": [
    {
      ...
      "schema:identifier": "session-vlm-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example VLM Instrument",
          "schema:identifier": "ex:instrument-vlm-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "VLM primary measurement"
      ],
      "schema:description": "Primary measured quantity from Visible Light Microscopy (VLM) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/vlm_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaVLM-ALH84001-archive.zip",
      "schema:description": "Archive containing VLM data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adavlm-example-001.zip",
      ...
      "schema:hasPart": [
        {
          "@id": "ex:adaVLM-file-001",
          "@type": [
            "ada:image",
            "schema:ImageObject"
          ],
          "schema:name": "ALH84001_VLM_001.tif",
          "schema:description": "VLM data file for ALH 84001 thin section",
          "schema:additionalType": [
            "ada:VLMImage"
          ],
          "schema:encodingFormat": [
        ...
        {
          "@id": "ex:adaVLM-file-002",
          "@type": [
            "ada:document",
            "schema:DigitalDocument"
          ],
          "schema:name": "ALH84001_VLM_methods.pdf",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaVLM"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaVLM/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaVLM-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Visible Light Microscopy (VLM) Image",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example Visible Light Microscopy (VLM) product metadata demonstrating all properties defined by the adaVLM profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adavlm-example-001.zip" ;
            schema1:description "Archive containing VLM data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaVLM-file-001,
                ex:adaVLM-file-002 ;
            schema1:name "adaVLM-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adavlm-example-001" ;
            schema1:value "10.99999/adavlm-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/VLM" ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "Visible Light Microscopy" ;
            schema1:termCode "VLM" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/VLM" ;
            schema1:name "Visible Light Microscopy (VLM)" ] ;
    schema1:name "VLM Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaVLM-metadata-001 ;
    schema1:url "https://astromat.org/products/adavlm-example-001" ;
    schema1:variableMeasured ex:adaVLM-var-001,
        ex:adaVLM-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:VLMInstrument" ;
                    schema1:identifier "ex:instrument-vlm-001" ;
                    schema1:name "Example VLM Instrument" ] ] .

ex:adaVLM-file-001 a schema1:ImageObject,
        ada:image ;
    schema1:additionalType "ada:VLMImage" ;
    schema1:description "VLM data file for ALH 84001 thin section" ;
    schema1:encodingFormat "image/tiff" ;
    schema1:name "ALH84001_VLM_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaVLM-file-002 a schema1:DigitalDocument,
        ada:document ;
    schema1:additionalType "ada:methodDescription" ;
    schema1:description "Method description document for this analysis" ;
    schema1:encodingFormat "application/pdf" ;
    schema1:name "ALH84001_VLM_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
            schema1:value 524288 ] .

ex:adaVLM-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaVLM> ;
    schema1:about ex:adaVLM-example-001 ;
...
ex:adaVLM-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "VLM primary measurement" ;
    schema1:description "Primary measured quantity from Visible Light Microscopy (VLM) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/vlm_primary" ;
    schema1:unitText "counts" .

ex:adaVLM-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
...
* YAML version: [schema.yaml](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaVLM/schema.json)
* JSON version: [schema.json](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaVLM/schema.yaml)
...
[context.jsonld](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaVLM/context.jsonld)
...
* Path: `_sources/profiles/adaProfiles/adaVLM`
