...
Example Raman Spectroscopy (RAMAN) product metadata with all properties populated.
...
```json
{
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adaraman-example-001",
    "schema:url": "https://doi.org/10.99999/adaraman-example-001"
  },
  "schema:url": "https://astromat.org/products/adaraman-example-001",
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Raman Spectroscopy (RAMAN)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/RAMAN"
  },
  "prov:wasGeneratedBy": [
    {
      "@type": [
      ...
      "schema:identifier": "session-raman-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example RAMAN Instrument",
          "schema:identifier": "ex:instrument-raman-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "RAMAN primary measurement"
      ],
      "schema:description": "Primary measured quantity from Raman Spectroscopy (RAMAN) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/raman_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaRAMAN-ALH84001-archive.zip",
      "schema:description": "Archive containing RAMAN data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adaraman-example-001.zip",
      ...
      "schema:hasPart": [
        {
          "@id": "ex:adaRAMAN-file-001",
          "@type": [
            "ada:image",
            "schema:ImageObject"
          ],
          "schema:name": "ALH84001_RAMAN_001.tif",
          "schema:description": "RAMAN data file for ALH 84001 thin section",
          "schema:additionalType": [
            "ada:RAMANRawTabular"
          ],
          "schema:encodingFormat": [
          ...
          "componentType": {
            "@type": "ada:RAMANRawTabular"
          }
        },
        {
          "@id": "ex:adaRAMAN-file-002",
          "@type": [
            "ada:document",
            "schema:DigitalDocument"
          ],
          "schema:name": "ALH84001_RAMAN_methods.pdf",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaRAMAN"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaRAMAN/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaRAMAN-example-001 a schema1:Dataset,
    ...
    schema1:description "Example Raman Spectroscopy (RAMAN) product metadata demonstrating all properties defined by the adaRAMAN profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adaraman-example-001.zip" ;
            schema1:description "Archive containing RAMAN data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaRAMAN-file-001,
                ex:adaRAMAN-file-002 ;
            schema1:name "adaRAMAN-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adaraman-example-001" ;
            schema1:value "10.99999/adaraman-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "RAMAN" ;
            schema1:termCode "RAMAN" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/RAMAN" ;
            schema1:name "Raman Spectroscopy (RAMAN)" ] ;
    schema1:name "RAMAN Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaRAMAN-metadata-001 ;
    schema1:url "https://astromat.org/products/adaraman-example-001" ;
    schema1:variableMeasured ex:adaRAMAN-var-001,
        ex:adaRAMAN-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-raman-20260110-001" ;
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:RAMANInstrument" ;
                    schema1:identifier "ex:instrument-raman-001" ;
                    schema1:name "Example RAMAN Instrument" ] ] .

ex:adaRAMAN-file-001 a schema1:ImageObject,
        ada:image ;
    schema1:additionalType "ada:RAMANRawTabular" ;
    schema1:description "RAMAN data file for ALH 84001 thin section" ;
    schema1:encodingFormat "image/tiff" ;
    schema1:name "ALH84001_RAMAN_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaRAMAN-file-002 a schema1:DigitalDocument,
        ada:document ;
    schema1:additionalType "ada:methodDescription" ;
    schema1:description "Method description document for this analysis" ;
    schema1:encodingFormat "application/pdf" ;
    schema1:name "ALH84001_RAMAN_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
            schema1:value 524288 ] .

ex:adaRAMAN-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaRAMAN> ;
    schema1:about ex:adaRAMAN-example-001 ;
...
ex:adaRAMAN-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "RAMAN primary measurement" ;
    schema1:description "Primary measured quantity from Raman Spectroscopy (RAMAN) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/raman_primary" ;
    schema1:unitText "counts" .

ex:adaRAMAN-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
