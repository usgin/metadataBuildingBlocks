...
`cdif.bbr.metadata.profiles.adaProfiles.adaXRD` *v0.1*
...
### XRD Product Example
Example X-ray Diffraction (XRD) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaXRD-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "XRD Analysis of Meteorite ALH 84001 Fragment",
  "schema:description": "Example X-ray Diffraction (XRD) product metadata demonstrating all properties defined by the adaXRD profile. Contains mock data for testing and validation.",
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adaxrd-example-001",
    "schema:url": "https://doi.org/10.99999/adaxrd-example-001"
  },
  "schema:url": "https://astromat.org/products/adaxrd-example-001",
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "X-ray Diffraction (XRD)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/XRD"
  },
  "prov:wasGeneratedBy": [
    {
      ...
      "schema:identifier": "session-xrd-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:identifier": "ex:instrument-xrd-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "XRD primary measurement"
      ],
      "schema:description": "Primary measured quantity from X-ray Diffraction (XRD) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/xrd_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaXRD-ALH84001-archive.zip",
      "schema:description": "Archive containing XRD data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adaxrd-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaXRD"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaXRD/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaXRD-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "X-ray Diffraction (XRD) Tabular",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example X-ray Diffraction (XRD) product metadata demonstrating all properties defined by the adaXRD profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adaxrd-example-001.zip" ;
            schema1:description "Archive containing XRD data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaXRD-file-001,
                ex:adaXRD-file-002 ;
            schema1:name "adaXRD-ALH84001-archive.zip" ;
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/XRD" ;
            schema1:name "X-ray Diffraction (XRD)" ] ;
    schema1:name "XRD Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaXRD-metadata-001 ;
    schema1:url "https://astromat.org/products/adaxrd-example-001" ;
    schema1:variableMeasured ex:adaXRD-var-001,
        ex:adaXRD-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-xrd-20260110-001" ;
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:XRDInstrument" ;
...
ex:adaXRD-file-001 a schema1:ImageObject,
    ...
    schema1:name "ALH84001_XRD_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaXRD-metadata-001 a schema1:Dataset ;
    ...
    schema1:about ex:adaXRD-example-001 ;
...
ex:adaXRD-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "XRD primary measurement" ;
    schema1:description "Primary measured quantity from X-ray Diffraction (XRD) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/xrd_primary" ;
    schema1:unitText "counts" .

ex:adaXRD-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
...
* YAML version: [schema.yaml](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaXRD/schema.json)
* JSON version: [schema.json](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaXRD/schema.yaml)
...
[context.jsonld](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaXRD/context.jsonld)
...
* Path: `_sources/profiles/adaProfiles/adaXRD`
