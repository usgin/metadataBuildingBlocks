...
Example AI-driven Visual Analysis (AIVA) product metadata with all properties populated.
...
```json
{
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adaaiva-example-001",
    "schema:url": "https://doi.org/10.99999/adaaiva-example-001"
  },
  "schema:url": "https://astromat.org/products/adaaiva-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "Advanced Imaging and Visualization of Astromaterials",
      "schema:termCode": "AIVA",
      "schema:inDefinedTermSet": "https://ada.astromat.org/vocabulary/techniques",
      "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/AIVA"
    },
    "meteorite",
    "astromaterials"
  ],
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "AI-driven Visual Analysis (AIVA)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/AIVA"
  },
  "prov:wasGeneratedBy": [
    {
      ...
      "schema:identifier": "session-aiva-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example AIVA Instrument",
          "schema:identifier": "ex:instrument-aiva-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "AIVA primary measurement"
      ],
      "schema:description": "Primary measured quantity from AI-driven Visual Analysis (AIVA) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/aiva_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaAIVA-ALH84001-archive.zip",
      "schema:description": "Archive containing AIVA data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adaaiva-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaAIVA"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaAIVA/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaAIVA-example-001 a schema1:Dataset,
    ...
    schema1:description "Example AI-driven Visual Analysis (AIVA) product metadata demonstrating all properties defined by the adaAIVA profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adaaiva-example-001.zip" ;
            schema1:description "Archive containing AIVA data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaAIVA-file-001,
                ex:adaAIVA-file-002 ;
            schema1:name "adaAIVA-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adaaiva-example-001" ;
            schema1:value "10.99999/adaaiva-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/AIVA" ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "Advanced Imaging and Visualization of Astromaterials" ;
            schema1:termCode "AIVA" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/AIVA" ;
            schema1:name "AI-driven Visual Analysis (AIVA)" ] ;
    schema1:name "AIVA Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaAIVA-metadata-001 ;
    schema1:url "https://astromat.org/products/adaaiva-example-001" ;
    schema1:variableMeasured ex:adaAIVA-var-001,
        ex:adaAIVA-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-aiva-20260110-001" ;
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:AIVAInstrument" ;
                    schema1:identifier "ex:instrument-aiva-001" ;
...
ex:adaAIVA-file-001 a schema1:ImageObject,
    ...
    schema1:name "ALH84001_AIVA_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaAIVA-file-002 a schema1:DigitalDocument,
    ...
    schema1:name "ALH84001_AIVA_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
            schema1:value 524288 ] .

ex:adaAIVA-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaAIVA> ;
    schema1:about ex:adaAIVA-example-001 ;
...
ex:adaAIVA-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "AIVA primary measurement" ;
    schema1:description "Primary measured quantity from AI-driven Visual Analysis (AIVA) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/aiva_primary" ;
    schema1:unitText "counts" .

ex:adaAIVA-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
