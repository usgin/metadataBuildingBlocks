...
`cdif.bbr.metadata.profiles.adaProfiles.adaUVFM` *v0.1*
...
Example Ultraviolet Fluorescence Microscopy (UVFM) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaUVFM-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "UVFM Analysis of Meteorite ALH 84001 Fragment",
  ...
  "schema:url": "https://astromat.org/products/adauvfm-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "Fluorescence Microscopy",
      "schema:termCode": "UVFM",
      "schema:inDefinedTermSet": "https://ada.astromat.org/vocabulary/techniques",
      "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/UVFM"
    },
    "meteorite",
    "astromaterials"
  ],
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Ultraviolet Fluorescence Microscopy (UVFM)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/UVFM"
  },
  "prov:wasGeneratedBy": [
    {
      ...
      "schema:identifier": "session-uvfm-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example UVFM Instrument",
          "schema:identifier": "ex:instrument-uvfm-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaUVFM-ALH84001-archive.zip",
      "schema:description": "Archive containing UVFM data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adauvfm-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaUVFM"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaUVFM/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaUVFM-example-001 a schema1:Dataset,
    ...
    schema1:description "Example Ultraviolet Fluorescence Microscopy (UVFM) product metadata demonstrating all properties defined by the adaUVFM profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adauvfm-example-001.zip" ;
            schema1:description "Archive containing UVFM data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaUVFM-file-001,
                ex:adaUVFM-file-002 ;
            schema1:name "adaUVFM-ALH84001-archive.zip" ;
    ...
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/UVFM" ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "Fluorescence Microscopy" ;
            schema1:termCode "UVFM" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/UVFM" ;
            schema1:name "Ultraviolet Fluorescence Microscopy (UVFM)" ] ;
    schema1:name "UVFM Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaUVFM-metadata-001 ;
    schema1:url "https://astromat.org/products/adauvfm-example-001" ;
    schema1:variableMeasured ex:adaUVFM-var-001,
        ex:adaUVFM-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-uvfm-20260110-001" ;
...
ex:adaUVFM-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaUVFM> ;
    schema1:about ex:adaUVFM-example-001 ;
...
ex:adaUVFM-var-001 a cdi:InstanceVariable,
...
ex:adaUVFM-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
...
* YAML version: [schema.yaml](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaUVFM/schema.json)
* JSON version: [schema.json](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaUVFM/schema.yaml)
...
[context.jsonld](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaUVFM/context.jsonld)
...
* Path: `_sources/profiles/adaProfiles/adaUVFM`
