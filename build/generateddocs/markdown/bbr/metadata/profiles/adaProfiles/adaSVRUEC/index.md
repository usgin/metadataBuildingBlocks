...
`cdif.bbr.metadata.profiles.adaProfiles.adaSVRUEC` *v0.1*
...
Example Seismic Velocities and Rock Ultrasonic Elastic Constants (SV-RUEC) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaSVRUEC-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "SV-RUEC Analysis of Meteorite ALH 84001 Fragment",
  ...
  "schema:url": "https://astromat.org/products/adasvruec-example-001",
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Seismic Velocities and Rock Ultrasonic Elastic Constants (SV-RUEC)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/SV-RUEC"
  },
  "prov:wasGeneratedBy": [
    {
      "@type": [
      ...
      "schema:identifier": "session-sv-ruec-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example SV-RUEC Instrument",
          "schema:identifier": "ex:instrument-sv-ruec-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaSVRUEC-ALH84001-archive.zip",
      "schema:description": "Archive containing SV-RUEC data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adasvruec-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaSVRUEC"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaSVRUEC/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaSVRUEC-example-001 a schema1:Dataset,
    ...
    schema1:description "Example Seismic Velocities and Rock Ultrasonic Elastic Constants (SV-RUEC) product metadata demonstrating all properties defined by the adaSVRUEC profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adasvruec-example-001.zip" ;
            schema1:description "Archive containing SV-RUEC data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaSVRUEC-file-001,
                ex:adaSVRUEC-file-002 ;
            schema1:name "adaSVRUEC-ALH84001-archive.zip" ;
    ...
    schema1:keywords [ a schema1:DefinedTerm ;
            ...
            schema1:name "SV-RUEC" ;
            schema1:termCode "SV-RUEC" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/SV-RUEC" ;
            schema1:name "Seismic Velocities and Rock Ultrasonic Elastic Constants (SV-RUEC)" ] ;
    schema1:name "SV-RUEC Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaSVRUEC-metadata-001 ;
    schema1:url "https://astromat.org/products/adasvruec-example-001" ;
    schema1:variableMeasured ex:adaSVRUEC-var-001,
        ex:adaSVRUEC-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-sv-ruec-20260110-001" ;
...
ex:adaSVRUEC-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaSVRUEC> ;
    schema1:about ex:adaSVRUEC-example-001 ;
...
ex:adaSVRUEC-var-001 a cdi:InstanceVariable,
...
ex:adaSVRUEC-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
...
* YAML version: [schema.yaml](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaSVRUEC/schema.json)
* JSON version: [schema.json](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaSVRUEC/schema.yaml)
...
[context.jsonld](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaSVRUEC/context.jsonld)
...
* Path: `_sources/profiles/adaProfiles/adaSVRUEC`
