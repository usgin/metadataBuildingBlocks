...
`cdif.bbr.metadata.profiles.adaProfiles.adaRITOFNGMS` *v0.1*
...
Example Resonance Ionization Time-of-Flight Noble Gas Mass Spectrometry (RI-TOF-NGMS) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaRITOFNGMS-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "RI-TOF-NGMS Analysis of Meteorite ALH 84001 Fragment",
  "schema:description": "Example Resonance Ionization Time-of-Flight Noble Gas Mass Spectrometry (RI-TOF-NGMS) product metadata demonstrating all properties defined by the adaRITOFNGMS profile. Contains mock data for testing and validation.",
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adaritofngms-example-001",
    "schema:url": "https://doi.org/10.99999/adaritofngms-example-001"
  },
  "schema:url": "https://astromat.org/products/adaritofngms-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "RI-TOF-NGMS",
      "schema:termCode": "RI-TOF-NGMS",
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Resonance Ionization Time-of-Flight Noble Gas Mass Spectrometry (RI-TOF-NGMS)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/RI-TOF-NGMS"
  },
  "prov:wasGeneratedBy": [
    {
      "@type": [
      ...
      "schema:identifier": "session-ri-tof-ngms-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:additionalType": [
            "ada:RI-TOF-NGMSInstrument"
          ],
          "schema:name": "Example RI-TOF-NGMS Instrument",
          "schema:identifier": "ex:instrument-ri-tof-ngms-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "RI-TOF-NGMS primary measurement"
      ],
      "schema:description": "Primary measured quantity from Resonance Ionization Time-of-Flight Noble Gas Mass Spectrometry (RI-TOF-NGMS) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/ri-tof-ngms_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaRITOFNGMS-ALH84001-archive.zip",
      "schema:description": "Archive containing RI-TOF-NGMS data files and supplementary materials",
      ...
      "schema:hasPart": [
        {
          "@id": "ex:adaRITOFNGMS-file-001",
          "@type": [
            "ada:image",
            "schema:ImageObject"
          ],
          "schema:name": "ALH84001_RI-TOF-NGMS_001.tif",
          "schema:description": "RI-TOF-NGMS data file for ALH 84001 thin section",
          "schema:additionalType": [
            "ada:RITOFNGMSTabular"
          ],
          "schema:encodingFormat": [
          ...
          "componentType": {
            "@type": "ada:RITOFNGMSTabular"
          }
        },
        {
          "@id": "ex:adaRITOFNGMS-file-002",
          "@type": [
            "ada:document",
            "schema:DigitalDocument"
          ],
          "schema:name": "ALH84001_RI-TOF-NGMS_methods.pdf",
  ...
  "schema:subjectOf": {
    ...
    "@id": "ex:adaRITOFNGMS-metadata-001",
    "schema:about": {
      "@id": "ex:adaRITOFNGMS-example-001"
    },
    "schema:dateModified": "2026-01-15",
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaRITOFNGMS"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaRITOFNGMS/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaRITOFNGMS-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Resonance ionization time of flight noble gas mass spectrometry (RITOFNGMS) Spectra",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:distribution [ a schema1:DataDownload ;
            ...
            schema1:hasPart ex:adaRITOFNGMS-file-001,
                ex:adaRITOFNGMS-file-002 ;
            schema1:name "adaRITOFNGMS-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adaritofngms-example-001" ;
            schema1:value "10.99999/adaritofngms-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "RI-TOF-NGMS" ;
            schema1:termCode "RI-TOF-NGMS" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/RI-TOF-NGMS" ;
            schema1:name "Resonance Ionization Time-of-Flight Noble Gas Mass Spectrometry (RI-TOF-NGMS)" ] ;
    schema1:name "RI-TOF-NGMS Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaRITOFNGMS-metadata-001 ;
    schema1:url "https://astromat.org/products/adaritofngms-example-001" ;
    schema1:variableMeasured ex:adaRITOFNGMS-var-001,
        ex:adaRITOFNGMS-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-ri-tof-ngms-20260110-001" ;
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:RI-TOF-NGMSInstrument" ;
                    schema1:identifier "ex:instrument-ri-tof-ngms-001" ;
                    schema1:name "Example RI-TOF-NGMS Instrument" ] ] .

ex:adaRITOFNGMS-file-001 a schema1:ImageObject,
        ada:image ;
    schema1:additionalType "ada:RITOFNGMSTabular" ;
    schema1:description "RI-TOF-NGMS data file for ALH 84001 thin section" ;
    schema1:encodingFormat "image/tiff" ;
    schema1:name "ALH84001_RI-TOF-NGMS_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaRITOFNGMS-file-002 a schema1:DigitalDocument,
        ada:document ;
    schema1:additionalType "ada:methodDescription" ;
    schema1:description "Method description document for this analysis" ;
    schema1:encodingFormat "application/pdf" ;
    schema1:name "ALH84001_RI-TOF-NGMS_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
            schema1:value 524288 ] .

ex:adaRITOFNGMS-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaRITOFNGMS> ;
    schema1:about ex:adaRITOFNGMS-example-001 ;
...
ex:adaRITOFNGMS-var-001 a cdi:InstanceVariable,
    ...
    schema1:description "Primary measured quantity from Resonance Ionization Time-of-Flight Noble Gas Mass Spectrometry (RI-TOF-NGMS) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/ri-tof-ngms_primary" ;
...
* YAML version: [schema.yaml](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaRITOFNGMS/schema.json)
* JSON version: [schema.json](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaRITOFNGMS/schema.yaml)
...
[context.jsonld](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaRITOFNGMS/context.jsonld)
...
* Path: `_sources/profiles/adaProfiles/adaRITOFNGMS`
