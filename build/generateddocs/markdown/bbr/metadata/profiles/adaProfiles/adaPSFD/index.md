...
Example Particle Size-Frequency Distribution (PSFD) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaPSFD-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "PSFD Analysis of Meteorite ALH 84001 Fragment",
  ...
  "schema:url": "https://astromat.org/products/adapsfd-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "Particle Size Frequency Distribution",
      "schema:termCode": "PSFD",
      "schema:inDefinedTermSet": "https://ada.astromat.org/vocabulary/techniques",
      "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/PSFD"
    },
    "meteorite",
    "astromaterials"
  ],
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Particle Size-Frequency Distribution (PSFD)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/PSFD"
  },
  "prov:wasGeneratedBy": [
    {
      ...
      "schema:identifier": "session-psfd-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example PSFD Instrument",
          "schema:identifier": "ex:instrument-psfd-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaPSFD-ALH84001-archive.zip",
      "schema:description": "Archive containing PSFD data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adapsfd-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaPSFD"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaPSFD/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaPSFD-example-001 a schema1:Dataset,
    ...
    schema1:description "Example Particle Size-Frequency Distribution (PSFD) product metadata demonstrating all properties defined by the adaPSFD profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adapsfd-example-001.zip" ;
            schema1:description "Archive containing PSFD data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaPSFD-file-001,
                ex:adaPSFD-file-002 ;
            schema1:name "adaPSFD-ALH84001-archive.zip" ;
    ...
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/PSFD" ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "Particle Size Frequency Distribution" ;
            schema1:termCode "PSFD" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/PSFD" ;
            schema1:name "Particle Size-Frequency Distribution (PSFD)" ] ;
    schema1:name "PSFD Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaPSFD-metadata-001 ;
    schema1:url "https://astromat.org/products/adapsfd-example-001" ;
    schema1:variableMeasured ex:adaPSFD-var-001,
        ex:adaPSFD-var-002 ;
    schema1:version "1.0" ;
...
ex:adaPSFD-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaPSFD> ;
    schema1:about ex:adaPSFD-example-001 ;
...
ex:adaPSFD-var-001 a cdi:InstanceVariable,
...
ex:adaPSFD-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
