...
Example Liquid Chromatography Mass Spectrometry (LC-MS) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaLCMS-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "LC-MS Analysis of Meteorite ALH 84001 Fragment",
  ...
  "schema:url": "https://astromat.org/products/adalcms-example-001",
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Liquid Chromatography Mass Spectrometry (LC-MS)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/LC-MS"
  },
  "prov:wasGeneratedBy": [
    {
      "@type": [
      ...
      "schema:identifier": "session-lc-ms-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example LC-MS Instrument",
          "schema:identifier": "ex:instrument-lc-ms-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaLCMS-ALH84001-archive.zip",
      "schema:description": "Archive containing LC-MS data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adalcms-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaLCMS"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaLCMS/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaLCMS-example-001 a schema1:Dataset,
    ...
    schema1:description "Example Liquid Chromatography Mass Spectrometry (LC-MS) product metadata demonstrating all properties defined by the adaLCMS profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adalcms-example-001.zip" ;
            schema1:description "Archive containing LC-MS data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaLCMS-file-001,
                ex:adaLCMS-file-002 ;
            schema1:name "adaLCMS-ALH84001-archive.zip" ;
    ...
    schema1:keywords [ a schema1:DefinedTerm ;
            ...
            schema1:name "LC-MS" ;
            schema1:termCode "LC-MS" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/LC-MS" ;
            schema1:name "Liquid Chromatography Mass Spectrometry (LC-MS)" ] ;
    schema1:name "LC-MS Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaLCMS-metadata-001 ;
    schema1:url "https://astromat.org/products/adalcms-example-001" ;
    schema1:variableMeasured ex:adaLCMS-var-001,
        ex:adaLCMS-var-002 ;
    schema1:version "1.0" ;
...
ex:adaLCMS-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaLCMS> ;
    schema1:about ex:adaLCMS-example-001 ;
...
ex:adaLCMS-var-001 a cdi:InstanceVariable,
...
ex:adaLCMS-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
