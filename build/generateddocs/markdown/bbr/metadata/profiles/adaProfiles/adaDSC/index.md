...
### DSC Product Example
Example Differential Scanning Calorimetry (DSC) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaDSC-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "DSC Analysis of Meteorite ALH 84001 Fragment",
  ...
  "schema:url": "https://astromat.org/products/adadsc-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "Differential Scanning Calorimetry",
      "schema:termCode": "DSC",
      "schema:inDefinedTermSet": "https://ada.astromat.org/vocabulary/techniques",
      "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/DSC"
    },
    "meteorite",
    "astromaterials"
  ],
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Differential Scanning Calorimetry (DSC)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/DSC"
  },
  "prov:wasGeneratedBy": [
    {
      ...
      "schema:identifier": "session-dsc-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example DSC Instrument",
          "schema:identifier": "ex:instrument-dsc-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaDSC-ALH84001-archive.zip",
      "schema:description": "Archive containing DSC data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adadsc-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaDSC"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaDSC/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaDSC-example-001 a schema1:Dataset,
    ...
    schema1:description "Example Differential Scanning Calorimetry (DSC) product metadata demonstrating all properties defined by the adaDSC profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adadsc-example-001.zip" ;
            schema1:description "Archive containing DSC data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaDSC-file-001,
                ex:adaDSC-file-002 ;
            schema1:name "adaDSC-ALH84001-archive.zip" ;
    ...
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/DSC" ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "Differential Scanning Calorimetry" ;
            schema1:termCode "DSC" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/DSC" ;
            schema1:name "Differential Scanning Calorimetry (DSC)" ] ;
    schema1:name "DSC Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaDSC-metadata-001 ;
    schema1:url "https://astromat.org/products/adadsc-example-001" ;
    schema1:variableMeasured ex:adaDSC-var-001,
        ex:adaDSC-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-dsc-20260110-001" ;
...
ex:adaDSC-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaDSC> ;
    schema1:about ex:adaDSC-example-001 ;
...
ex:adaDSC-var-001 a cdi:InstanceVariable,
...
ex:adaDSC-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
