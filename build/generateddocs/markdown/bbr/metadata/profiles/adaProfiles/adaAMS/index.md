...
### AMS Product Example
Example Accelerator Mass Spectrometry (AMS) product metadata with all properties populated.
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaAMS/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaAMS-example-001 a schema1:Dataset,
        schema1:Product ;
    ...
    schema1:description "Example Accelerator Mass Spectrometry (AMS) product metadata demonstrating all properties defined by the adaAMS profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adaams-example-001.zip" ;
            schema1:description "Archive containing AMS data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaAMS-file-001,
                ex:adaAMS-file-002 ;
            schema1:name "adaAMS-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adaams-example-001" ;
            schema1:value "10.99999/adaams-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/AMS" ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "Accelerator Mass Spectrometry" ;
            schema1:termCode "AMS" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/AMS" ;
            schema1:name "Accelerator Mass Spectrometry (AMS)" ] ;
    schema1:name "AMS Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaAMS-metadata-001 ;
    schema1:url "https://astromat.org/products/adaams-example-001" ;
    schema1:variableMeasured ex:adaAMS-var-001,
        ex:adaAMS-var-002 ;
    schema1:version "1.0" ;
...
ex:adaAMS-file-001 a schema1:ImageObject,
    ...
    schema1:name "ALH84001_AMS_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaAMS-file-002 a schema1:DigitalDocument,
    ...
    schema1:name "ALH84001_AMS_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaAMS-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "AMS primary measurement" ;
    schema1:description "Primary measured quantity from Accelerator Mass Spectrometry (AMS) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/ams_primary" ;
    schema1:unitText "counts" .

ex:adaAMS-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
