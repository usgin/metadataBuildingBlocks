...
Example Nano-Infrared Spectroscopy (NanoIR) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaNanoIR-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "NanoIR Analysis of Meteorite ALH 84001 Fragment",
  "schema:description": "Example Nano-Infrared Spectroscopy (NanoIR) product metadata demonstrating all properties defined by the adaNanoIR profile. Contains mock data for testing and validation.",
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adananoir-example-001",
    "schema:url": "https://doi.org/10.99999/adananoir-example-001"
  },
  "schema:url": "https://astromat.org/products/adananoir-example-001",
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Nano-Infrared Spectroscopy (NanoIR)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/NanoIR"
  },
  "prov:wasGeneratedBy": [
    {
      "@type": [
      ...
      "schema:identifier": "session-nanoir-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:identifier": "ex:instrument-nanoir-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "NanoIR primary measurement"
      ],
      "schema:description": "Primary measured quantity from Nano-Infrared Spectroscopy (NanoIR) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/nanoir_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaNanoIR-ALH84001-archive.zip",
      "schema:description": "Archive containing NanoIR data files and supplementary materials",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaNanoIR"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaNanoIR/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaNanoIR-example-001 a schema1:Dataset,
        schema1:Product ;
    ...
    schema1:distribution [ a schema1:DataDownload ;
            ...
            schema1:hasPart ex:adaNanoIR-file-001,
                ex:adaNanoIR-file-002 ;
            schema1:name "adaNanoIR-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adananoir-example-001" ;
            schema1:value "10.99999/adananoir-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "NanoIR" ;
            schema1:termCode "NanoIR" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/NanoIR" ;
            schema1:name "Nano-Infrared Spectroscopy (NanoIR)" ] ;
    schema1:name "NanoIR Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaNanoIR-metadata-001 ;
    schema1:url "https://astromat.org/products/adananoir-example-001" ;
    schema1:variableMeasured ex:adaNanoIR-var-001,
        ex:adaNanoIR-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-nanoir-20260110-001" ;
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:NanoIRInstrument" ;
...
ex:adaNanoIR-file-001 a schema1:ImageObject,
    ...
    schema1:name "ALH84001_NanoIR_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaNanoIR-file-002 a schema1:DigitalDocument,
    ...
    schema1:name "ALH84001_NanoIR_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
            schema1:value 524288 ] .

ex:adaNanoIR-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaNanoIR> ;
    schema1:about ex:adaNanoIR-example-001 ;
...
ex:adaNanoIR-var-001 a cdi:InstanceVariable,
    ...
    schema1:description "Primary measured quantity from Nano-Infrared Spectroscopy (NanoIR) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/nanoir_primary" ;
