...
`cdif.bbr.metadata.profiles.adaProfiles.adaSIMS` *v0.1*
...
Example Secondary Ion Mass Spectrometry (SIMS) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaSIMS-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "SIMS Analysis of Meteorite ALH 84001 Fragment",
  "schema:description": "Example Secondary Ion Mass Spectrometry (SIMS) product metadata demonstrating all properties defined by the adaSIMS profile. Contains mock data for testing and validation.",
  ...
  "schema:identifier": {
    ...
    "schema:value": "10.99999/adasims-example-001",
    "schema:url": "https://doi.org/10.99999/adasims-example-001"
  },
  "schema:url": "https://astromat.org/products/adasims-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "Secondary Ion Mass Spectrometry",
      "schema:termCode": "SIMS",
      "schema:inDefinedTermSet": "https://ada.astromat.org/vocabulary/techniques",
      "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/SIMS"
    },
    "meteorite",
    "astromaterials"
  ],
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Secondary Ion Mass Spectrometry (SIMS)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/SIMS"
  },
  "prov:wasGeneratedBy": [
    {
      ...
      "schema:identifier": "session-sims-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example SIMS Instrument",
          "schema:identifier": "ex:instrument-sims-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:variableMeasured": [
    {
      ...
      "schema:alternateName": [
        "SIMS primary measurement"
      ],
      "schema:description": "Primary measured quantity from Secondary Ion Mass Spectrometry (SIMS) analysis. This is example mock data for testing.",
      "schema:propertyID": [
        "https://ada.astromat.org/vocabulary/variables/sims_primary"
      ],
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaSIMS-ALH84001-archive.zip",
      "schema:description": "Archive containing SIMS data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adasims-example-001.zip",
      ...
      "schema:hasPart": [
        {
          "@id": "ex:adaSIMS-file-001",
          "@type": [
            "ada:image",
            "schema:ImageObject"
          ],
          "schema:name": "ALH84001_SIMS_001.tif",
          "schema:description": "SIMS data file for ALH 84001 thin section",
          "schema:additionalType": [
            "ada:SIMSTabular"
          ],
          "schema:encodingFormat": [
          ...
          "componentType": {
            "@type": "ada:SIMSTabular"
          }
        },
        {
          "@id": "ex:adaSIMS-file-002",
          "@type": [
            "ada:document",
            "schema:DigitalDocument"
          ],
          "schema:name": "ALH84001_SIMS_methods.pdf",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaSIMS"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaSIMS/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaSIMS-example-001 a schema1:Dataset,
        schema1:Product ;
    schema1:additionalType "Secondary Ion Mass Spectrometry (SIMS) Tabular",
        "ada:DataDeliveryPackage" ;
    ...
    schema1:description "Example Secondary Ion Mass Spectrometry (SIMS) product metadata demonstrating all properties defined by the adaSIMS profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adasims-example-001.zip" ;
            schema1:description "Archive containing SIMS data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaSIMS-file-001,
                ex:adaSIMS-file-002 ;
            schema1:name "adaSIMS-ALH84001-archive.zip" ;
    ...
    schema1:identifier [ a schema1:PropertyValue ;
            ...
            schema1:url "https://doi.org/10.99999/adasims-example-001" ;
            schema1:value "10.99999/adasims-example-001" ] ;
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/SIMS" ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "Secondary Ion Mass Spectrometry" ;
            schema1:termCode "SIMS" ],
        "astromaterials",
        "meteorite" ;
    schema1:license "https://creativecommons.org/licenses/by/4.0/" ;
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/SIMS" ;
            schema1:name "Secondary Ion Mass Spectrometry (SIMS)" ] ;
    schema1:name "SIMS Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaSIMS-metadata-001 ;
    schema1:url "https://astromat.org/products/adasims-example-001" ;
    schema1:variableMeasured ex:adaSIMS-var-001,
        ex:adaSIMS-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-sims-20260110-001" ;
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:SIMSInstrument" ;
                    schema1:identifier "ex:instrument-sims-001" ;
                    schema1:name "Example SIMS Instrument" ] ] .

ex:adaSIMS-file-001 a schema1:ImageObject,
        ada:image ;
    schema1:additionalType "ada:SIMSTabular" ;
    schema1:description "SIMS data file for ALH 84001 thin section" ;
    schema1:encodingFormat "image/tiff" ;
    schema1:name "ALH84001_SIMS_001.tif" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
...
ex:adaSIMS-file-002 a schema1:DigitalDocument,
        ada:document ;
    schema1:additionalType "ada:methodDescription" ;
    schema1:description "Method description document for this analysis" ;
    schema1:encodingFormat "application/pdf" ;
    schema1:name "ALH84001_SIMS_methods.pdf" ;
    schema1:size [ a schema1:QuantitativeValue ;
            schema1:unitText "byte" ;
            schema1:value 524288 ] .

ex:adaSIMS-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaSIMS> ;
    schema1:about ex:adaSIMS-example-001 ;
...
ex:adaSIMS-var-001 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "MeasureComponent" ;
    cdi:simpleUnitOfMeasure "counts" ;
    schema1:alternateName "SIMS primary measurement" ;
    schema1:description "Primary measured quantity from Secondary Ion Mass Spectrometry (SIMS) analysis. This is example mock data for testing." ;
    schema1:name "measurement_value" ;
    schema1:propertyID "https://ada.astromat.org/vocabulary/variables/sims_primary" ;
    schema1:unitText "counts" .

ex:adaSIMS-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
...
* YAML version: [schema.yaml](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaSIMS/schema.json)
* JSON version: [schema.json](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaSIMS/schema.yaml)
...
[context.jsonld](https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaSIMS/context.jsonld)
...
* Path: `_sources/profiles/adaProfiles/adaSIMS`
