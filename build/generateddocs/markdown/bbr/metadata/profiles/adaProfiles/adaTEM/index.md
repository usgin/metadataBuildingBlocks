...
### TEM Product Example
Example Transmission Electron Microscopy (TEM) product metadata with all properties populated.
...
```json
{
  ...
  "@id": "ex:adaTEM-example-001",
  "@type": [
    "schema:Dataset",
    "schema:Product"
  ],
  "schema:name": "TEM Analysis of Meteorite ALH 84001 Fragment",
  ...
  "schema:url": "https://astromat.org/products/adatem-example-001",
  ...
  "schema:keywords": [
    {
      ...
      "schema:name": "Transmission Electron Microscopy",
      "schema:termCode": "TEM",
      "schema:inDefinedTermSet": "https://ada.astromat.org/vocabulary/techniques",
      "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/TEM"
    },
    "meteorite",
    "astromaterials"
  ],
  ...
  "schema:measurementTechnique": {
    "@type": "schema:DefinedTerm",
    "schema:name": "Transmission Electron Microscopy (TEM)",
    "schema:identifier": "https://ada.astromat.org/vocabulary/techniques/TEM"
  },
  "prov:wasGeneratedBy": [
    {
      ...
      "schema:identifier": "session-tem-20260110-001",
      ...
      "prov:used": [
        {
          ...
          "schema:name": "Example TEM Instrument",
          "schema:identifier": "ex:instrument-tem-001"
        }
      ],
      "schema:location": {
        "@type": [
  ...
  "schema:distribution": [
    {
      ...
      "schema:name": "adaTEM-ALH84001-archive.zip",
      "schema:description": "Archive containing TEM data files and supplementary materials",
      "schema:contentUrl": "https://astromat.org/downloads/adatem-example-001.zip",
  ...
  "schema:subjectOf": {
    ...
    "dcterms:conformsTo": [
      {
        "@id": "https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaTEM"
      }
    ],
    "schema:maintainer": {
      "@type": "schema:Organization",
...
```jsonld
{
  "@context": [
    ...
    "https://usgin.github.io/metadataBuildingBlocks/build/annotated/bbr/metadata/profiles/adaProfiles/adaTEM/context.jsonld",
    {
      "schema": "http://schema.org/",
      "ada": "https://ada.astromat.org/metadata/",
      "cdi": "http://ddialliance.org/Specification/DDI-CDI/1.0/RDF/",
...
ex:adaTEM-example-001 a schema1:Dataset,
    ...
    schema1:description "Example Transmission Electron Microscopy (TEM) product metadata demonstrating all properties defined by the adaTEM profile. Contains mock data for testing and validation." ;
    schema1:distribution [ a schema1:DataDownload ;
            schema1:additionalType "RO-CRATE" ;
            schema1:contentUrl "https://astromat.org/downloads/adatem-example-001.zip" ;
            schema1:description "Archive containing TEM data files and supplementary materials" ;
            schema1:encodingFormat "application/zip" ;
            schema1:hasPart ex:adaTEM-file-001,
                ex:adaTEM-file-002 ;
            schema1:name "adaTEM-ALH84001-archive.zip" ;
    ...
    schema1:keywords [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/TEM" ;
            schema1:inDefinedTermSet "https://ada.astromat.org/vocabulary/techniques" ;
            schema1:name "Transmission Electron Microscopy" ;
    ...
    schema1:measurementTechnique [ a schema1:DefinedTerm ;
            schema1:identifier "https://ada.astromat.org/vocabulary/techniques/TEM" ;
            schema1:name "Transmission Electron Microscopy (TEM)" ] ;
    schema1:name "TEM Analysis of Meteorite ALH 84001 Fragment" ;
    schema1:subjectOf ex:adaTEM-metadata-001 ;
    schema1:url "https://astromat.org/products/adatem-example-001" ;
    schema1:variableMeasured ex:adaTEM-var-001,
        ex:adaTEM-var-002 ;
    schema1:version "1.0" ;
    prov:wasGeneratedBy [ a schema1:Action,
                prov:Activity ;
            schema1:identifier "session-tem-20260110-001" ;
            ...
            prov:used [ a <http://purl.org/nexusformat/definitions/BaseClass/NXinstrument>,
                        schema1:Thing,
                        prov:Entity ;
                    schema1:additionalType "ada:TEMInstrument" ;
                    schema1:identifier "ex:instrument-tem-001" ;
                    schema1:name "Example TEM Instrument" ] ] .
...
ex:adaTEM-metadata-001 a schema1:Dataset ;
    dcterms:conformsTo <https://w3id.org/cdif/bbr/metadata/profiles/adaProfiles/adaTEM> ;
    schema1:about ex:adaTEM-example-001 ;
...
ex:adaTEM-var-001 a cdi:InstanceVariable,
...
ex:adaTEM-var-002 a cdi:InstanceVariable,
        schema1:PropertyValue ;
    cdi:intendedDataType "https://www.w3.org/TR/xmlschema-2/#decimal" ;
    cdi:role "DimensionComponent" ;
    cdi:simpleUnitOfMeasure "um" ;
