...
```json
{
    ...
    "@graph": [
        ...
        {
            "@id": "ex:agent-maria-chen",
            "@type": "cdi:ProcessingAgent",
            "cdi:identifier": {
                "@type": "cdi:Identifier",
                "cdi:uri": "https://orcid.org/0000-0002-8765-4321",
                "cdi:nonDdiIdentifier": {
                    "@type": "cdi:NonDdiIdentifier",
                    "cdi:identifierContent": "0000-0002-8765-4321",
        ...
        {
            "@id": "ex:env-nbmg-lab",
            "@type": "cdi:ProductionEnvironment",
            "cdi:name": {
                "@type": "cdi:ObjectName",
                "cdi:name": "Nevada Bureau of Mines and Geology Analytical Lab"
            },
            "cdi:description": "Geochemistry analytical laboratory at the University of Nevada, Reno",
            "cdi:identifier": {
                "@type": "cdi:Identifier",
                "cdi:uri": "https://www.unr.edu/nbmg"
            }
        }
    ]
}
...
ex:env-nbmg-lab a cdi:ProductionEnvironment ;
    cdi:description "Geochemistry analytical laboratory at the University of Nevada, Reno" ;
    cdi:identifier [ a cdi:Identifier ;
            cdi:uri "https://www.unr.edu/nbmg" ] ;
    cdi:name [ a cdi:ObjectName ;
