...
| `DDEDiscovery` | DDE Geoscience Discovery profile — extends CDIF Discovery with DDE resource types, topic/acquisition keywords, and browse graphics |
...
| DDEproperties | `_sources/DDEproperties/` | DDE (Deep-time Digital Earth) geoscience metadata properties |
...
| profiles | `_sources/profiles/` | Composed profiles (ADA technique, CDIF/DDE discovery, ECRR resource type) |
